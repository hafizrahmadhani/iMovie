...
class MovieRepository(private val remoteDataSource: RemoteDataSource): SourceMovie {

    companion object{
        @Volatile
        private var position : MovieRepository?= null
        fun getPosition(remoteDataSource: RemoteDataSource) : MovieRepository =
            position ?: synchronized(this){
                position ?: MovieRepository(remoteDataSource)
            }
    }
